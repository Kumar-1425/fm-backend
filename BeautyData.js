...
async function BeautyData() {
    ...
    try {
        ...
        const data = await collection.find({skills:"Beauty and Spa"}).toArray()
        console.log('Data retrieved successfully from Beauty and Spa');
        return data;
    } catch (error) {
