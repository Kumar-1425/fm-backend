...
async function HostelsData() {
    ...
    try {
        ...
        const data = await collection.find({skills:"Hostels"}).toArray()
        console.log('Data retrieved successfully from Hostels Data');
        return data;
    } catch (error) {
