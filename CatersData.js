...
async function CatersData() {
    ...
    try {
        ...
        const data = await collection.find({skills:"Caterers"}).toArray()
        console.log('Data retrieved successfully from Caters');
        return data;
    } catch (error) {
