...
async function ContractorsData() {
    var client;
    try {
        ...
        const data = await collection.find({skills:"Contractors"}).toArray()
        console.log('Data retrieved successfully from Contractors');
        return data;
    } catch (error) {
...
module.exports = ContractorsData;