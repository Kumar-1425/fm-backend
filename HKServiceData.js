...
async function HKServiceData() {
    ...
    try {
        ...
        const data = await collection.find({skills:"HouseKeeping Services"}).toArray()
        console.log('Data retrieved successfully from House Keeping');
        return data;
    } catch (error) {
