...
async function EventOrganisers() {
    var client;
    try {
        ...
        const data = await collection.find({skills:"Event Organisers"}).toArray()
        console.log('Data retrieved successfully from Event Organisers');
        return data;
    } catch (error) {
...
module.exports = EventOrganisers;