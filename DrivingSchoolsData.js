...
async function DrivingSchoolsData() {
    var client;
    try {
        ...
        const data = await collection.find({skills:"Driving Schools"}).toArray()
        console.log('Data retrieved successfully from Driving Schools Data');
        return data;
    } catch (error) {
...
module.exports = DrivingSchoolsData;